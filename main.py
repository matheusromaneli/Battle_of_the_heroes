...
class Main():
        ...
        jogador1 = {'direita' : Sprite("Assets/Player1/Corrida-direita.png", 8), 'esquerda' :Sprite("Assets/Player1/Corrida-esquerda.png", 8), 'parado' :Sprite("Assets/Player1/Parado.png",5)}
        for i in jogador1:
            jogador1[i].set_position(20,janela.height - jogador1[i].height - 30)
            jogador1[i].set_total_duration(1000)
        jogador2 = {'direita' : Sprite("Assets/Player2/Corrida-direita.png", 8), 'esquerda' :Sprite("Assets/Player2/Corrida-esquerda.png", 8), 'parado' :Sprite("Assets/Player2/Parado.png",5)}
        for i in jogador2:
